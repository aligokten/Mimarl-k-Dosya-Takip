      ...
      <section className={`${cardCls} p-6`}>
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <input
            readOnly
            value={inviteLink}
            className="min-w-0 flex-1 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-xs text-slate-600 dark:border-slate-600 dark:bg-zinc-900/60 dark:text-slate-300"
          />
          <button
            onClick={() => {
