...
const ARSAPAY_URL = "https://www.arsapay.com/";

// Arsapay uygulamasını uygulama içinde açan modal. Arka plan blurlanır;
// bazı siteler iframe gömülmesini engelleyebildiğinden "yeni sekmede aç"
// seçeneği de sunulur.
function ArsapayModal({ onClose }: { onClose: () => void }) {
  return (
    <div
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-700 px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:brightness-110"
        >
          <CoinsIcon className="h-4 w-4" />
          Arsapay
        </button>
            ...
            <div className="mt-4 space-y-3">
              {serviceDistribution.map((service, idx) => (
                <div key={service.name}>
                  ...
                  <div className="mt-1.5 h-2.5 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-zinc-700">
                    <div
